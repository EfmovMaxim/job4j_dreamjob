...
public class VacancyControllerTest {
    ...
    public void whenRequestVacancyListPageThenGetPageWithVacancies() {
        var vacancy1 = new Vacancy(1, "test1", "desc1", 1, true, 2);
        var vacancy2 = new Vacancy(2, "test2", "desc2", 3, false, 4);
    ...
    public void whenPostVacancyWithFileThenSameDataAndRedirectToVacanciesPage() throws Exception {
        when(cityService.findById(any(Integer.class))).thenReturn(Optional.of(new City(1, "Москва")));

        var vacancy = new Vacancy(1, "test1", "desc1", new City(1, "Москва"), true, 2);
