...
public class Sql2oVacancyRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        ...
        var vacancy = sql2oVacancyRepository.save(new Vacancy(0, "title", "description", 1, true, file.getId()));
    ...
    public void whenSaveSeveralThenGetAll() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var vacancy1 = sql2oVacancyRepository.save(new Vacancy(0, "title1", "description1", 1, true, file.getId()));
        var vacancy2 = sql2oVacancyRepository.save(new Vacancy(0, "title2", "description2", 1, false, file.getId()));
        var vacancy3 = sql2oVacancyRepository.save(new Vacancy(0, "title3", "description3", 1, true, file.getId()));
    ...
    public void whenUpdateThenGetUpdated() {
        ...
        var updatedVacancy = new Vacancy(
                vacancy.getId(), "new title", "new description", 1,
                !vacancy.isVisible(), file.getId()
        );
    ...
    public void whenUpdateUnExistingVacancyThenGetFalse() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var vacancy = new Vacancy(0, "title", "description", 1, true, file.getId());
